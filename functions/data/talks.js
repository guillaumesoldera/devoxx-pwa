...
const retrieveTalkById =(talkId) => new Promise((resolve, reject) => {
    var foundTalk = talks.find(elem => elem.id === talkId);
    if (foundTalk) {
        resolve(foundTalk)
    } else {
